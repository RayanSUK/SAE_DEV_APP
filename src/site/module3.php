...
<main role="main">
    <div class="form-container-parent">
        <div class="form-container">
            ...
            <form method="POST">
                <label for="n">a : </label>
                <input type="number" min="2" name="n" id="n" placeholder="a" class="form-input" required>

                <label for="forme">b : </label>
                <input type="number" min="0" name="b" id="b" placeholder="b" class="form-input" required>

                <label for="forme">c : </label>
                <input type="number" min="0" name="c" id="c" placeholder="c" class="form-input" required>
